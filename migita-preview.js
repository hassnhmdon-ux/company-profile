(() => {
  const products = [
    {
      image: "/images/migita-ginger-70g.jpg?v=3",
      name: "Migita Ginger Hard Candy",
      detail: "Plastic bag / 70g",
    },
    {
      image: "/images/migita-mint-70g.jpg?v=3",
      name: "Migita Mint Hard Candy",
      detail: "Plastic bag / 70g",
    },
    {
      image: "/images/migita-cinnamon-70g.jpg?v=3",
      name: "Migita Cinnamon Hard Candy",
      detail: "Plastic bag / 70g",
    },
    {
      image: "/images/migita-ginger-honey-140g.jpg?v=3",
      name: "Migita Ginger Hard Candy with Honey Filling",
      detail: "Plastic bag / 140g",
    },
    {
      image: "/images/migita-pink-lemon-honey-140g.jpg?v=3",
  ...
  const ensureMigita = () => {
    ...
    button.innerHTML = `
      ...
      <img src="/images/migita-logo.png?v=3" alt="MIGITA logo" style="height:56px;width:100%;object-fit:contain;transform:scale(1.12)" loading="lazy" decoding="async" />
